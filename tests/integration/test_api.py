...
from llm_parse.api.app import create_app, lifespan
from llm_parse.api.app import main as app_main
...
@pytest.fixture
async def client(mock_parse_service: AsyncMock) -> AsyncGenerator[AsyncClient, None]:
    app = create_app()
...
class TestParseEndpoint:
    @pytest.mark.asyncio
    async def test_parse_success(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_parse_with_system_prompt(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
        mock_output = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_parse_failure(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
        mock_parse_service.parse.return_value = ParseResult(
    ...
    @pytest.mark.asyncio
    async def test_parse_empty_schema_returns_422(self, client: AsyncClient) -> None:
        resp = await client.post(
            "/parse",
            json={
                "prompt": "test",
    ...
    @pytest.mark.asyncio
    async def test_parse_missing_prompt_returns_422(self, client: AsyncClient) -> None:
        resp = await client.post(
            "/parse",
            json={
                "output_schema": SAMPLE_OUTPUT_SCHEMA,
    ...
    @pytest.mark.asyncio
    async def test_parse_missing_schema_returns_422(self, client: AsyncClient) -> None:
        resp = await client.post(
            "/parse",
            json={
                "prompt": "test",
...
class TestParseBatchEndpoint:
    @pytest.mark.asyncio
    async def test_batch_success(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_batch_mixed_results(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
        mock_output = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_batch_empty_items_returns_422(self, client: AsyncClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_batch_missing_schema_returns_422(self, client: AsyncClient) -> None:
        resp = await client.post(
            "/parse-batch",
            json={
                "items": [{"prompt": "q1"}],
...
class TestSchemaSecurity:
    @pytest.mark.asyncio
    async def test_dunder_field_name_returns_422(self, client: AsyncClient) -> None:
        """双下划线前缀字段名应被拒绝。"""
        resp = await client.post(
            "/parse",
            json={
    ...
    @pytest.mark.asyncio
    async def test_invalid_field_name_returns_422(self, client: AsyncClient) -> None:
        """无效标识符字段名应被拒绝。"""
        resp = await client.post(
            "/parse",
            json={
    ...
    @pytest.mark.asyncio
    async def test_too_many_properties_returns_422(self, client: AsyncClient) -> None:
        """超过 50 个字段应被拒绝。"""
    ...
    @pytest.mark.asyncio
    async def test_valid_field_names_accepted(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
        """合法字段名（含单下划线前缀）应被接受。"""
        mock_output = MagicMock()
...
class TestSchemaToModel:
    @pytest.mark.asyncio
    async def test_array_type_field(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_boolean_type_field(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
        mock_output = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_number_type_field(self, client: AsyncClient, mock_parse_service: AsyncMock) -> None:
        mock_output = MagicMock()
